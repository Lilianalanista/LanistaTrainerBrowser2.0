...
Ext.define('LanistaTrainer.controller.MeasuresController', {
    ...
    control: {
        "viewport #showMeasuresPanelButton": {
            click: 'onShowMeasuresPanelButtonClick'
        },
        "viewport #closeMeasuresPanelButton": {
            click: 'onCloseMeasuresPanelButtonClick'
        },
        "measuresPanel #measureTabs": {
            tabchange: 'onTabpanelTabChange'
        },
        "viewport  #chartTableButton": {
            click: 'onchartTableButtonClick'
        },
        "viewport #saveMeasureButton": {
            click: 'onSaveMeasuresButtonClick'
        },
        "viewport #cancelMeasureButton": {
            click: 'onCancelMeasureButtonClick'
        },
        "viewport #deleteMeasureButton": {
            click: 'onDeleteMeasureButtonClick'
        },
        "viewport #newMeasureButton": {
            click: 'onNewMeasureButtonClick'
        }
    },
    ...
    onchartTableButtonClick: function(button, e, eOpts) {
        ...
        if (!controller.currentPanel.get(activeTab.id) || controller.currentPanel.get(activeTab.id) === 'table'){
            ...
            //console.log('VALORES!!!!!!!');
            //console.log(controller.getMainStage().getEl().getHeight(true));


            //activeTab.down('#measuresChat').setHeight(controller.getMainStage().getEl().getHeight() - 400);
            ...
            console.log('VALores!!!!!!!!!!!');
            console.log(activeTab.down('#measuresChat').getHeight());
            console.log(activeTab.down('#measuresChat').getWidth());
