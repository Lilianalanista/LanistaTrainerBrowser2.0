...
Ext.define('LanistaTrainer.view.WeightsWindow_II', {
    ...
    alias: 'widget.weightswindow_ii',

    requires: [
        'LanistaTrainer.view.WeightsWindow_IIViewModel',
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                listeners: {
                                    click: 'onClearTrainingEntryButtonClick'
                                }
                            },
                            {
                                xtype: 'toolbar',
                            ...
                            me.processNumberpadTraining1({
                                ...
                                listeners: {
                                    afterrender: 'onNumberpadTrainingAfterRender'
                                }
                            }),
                            me.processTrainingHelpTrainingbuttons1({
                                ...
                                listeners: {
                                    afterrender: 'onTrainingHelpTrainingbuttonsAfterRender'
                                }
                            }),
                            {
                                xtype: 'fieldset',
                        ...
                        listeners: {
                            afterrender: 'onTrainingPickerAfterRender',
                            hide: 'onTrainingPickerHide'
                        }
                    }
                ]
            };
