...
Ext.define('LanistaTrainer.view.WeightPicker', {
    ...
    requires: [
        'LanistaTrainer.view.WeightPickerViewModel',
    ...
    listeners: {
        afterrender: 'onWeightPickerAfterRender',
        hide: 'onWeightPickerHide'
    },
            ...
            config = {
                items: [
                    ...
                    me.processNumberpad({
                        ...
                        listeners: {
                            afterrender: 'onNumberpadAfterRender'
                        }
                    }),
                    me.processTrainingHelpbuttons({
                        ...
                        listeners: {
                            afterrender: 'onTrainingHelpbuttonsAfterRender'
                        }
                    }),
                    {
                        xtype: 'button',
                        ...
                        listeners: {
                            click: 'onClearWeightEntryButtonClick'
                        }
                    }
                ]
            };
