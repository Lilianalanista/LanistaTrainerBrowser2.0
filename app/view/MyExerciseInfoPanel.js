...
Ext.define('LanistaTrainer.view.MyExerciseInfoPanel', {
    ...
    requires: [
        'LanistaTrainer.view.MyExerciseInfoPanelViewModel',
        'Ext.form.FieldSet',
    ...
    listeners: {
        afterrender: 'onMyExerciseInfoPanelAfterRender'
    },
                ...
                items: [
                    {
                        ...
                        items: [
                            me.processMyExercise_language({
                                ...
                                listeners: {
                                    change: 'onMyExercise_languageChange'
                                }
                            }),
                            {
                                xtype: 'textfield',
                            ...
                            },
                            {
                                ...
                                listeners: {
                                    blur: 'onMyExercise_executionBlur'
                                }
                            },
                            {
                                xtype: 'textareafield',
                    ...
                    },
                    {
                        ...
                        listeners: {
                            afterrender: 'onMyExercise_imagesAfterRender'
                        }
                    }
                ]
            };
    ...
    onMyExercise_nameBlur: function(component, event, eOpts) {
    ...
    onMyExercise_executionBlur: function(component, event, eOpts) {
        var currentLanguageField = component.up('#myExercise_configuration').down('#myExercise_language').getValue(),
            enter = /\n/gi;
    ...
    onMyExercise_errorsBlur: function(component, event, eOpts) {
        var currentLanguageField = component.up('#myExercise_configuration').down('#myExercise_language').getValue(),
            enter = /\n/gi;;
